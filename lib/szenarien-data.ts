...
export const SZENARIEN: Szenario[] = [
  // Szenario 1: Versetzungsgefährdung / Aggressiv / Bildungsnahe Familie
  {
    ...
    elterntyp: 'aggressiv',
    elternName: 'Herrn und Frau Berger',
    kindName: 'Maximilian',
    ...
    hintergrund: 'Elternprofil: Herr und Frau Berger, beide anwesend, Sohn Maximilian, 10. Klasse. Leistungen haben sich im letzten Halbjahr deutlich verschlechtert, Versetzung gefährdet. Beide Eltern sind Akademiker mit hohen Erwartungen. Sie sehen die Schule in der Verantwortung.',
