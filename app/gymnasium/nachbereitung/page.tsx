        ...
        <main style={{ padding: '2rem', maxWidth: 800, margin: '0 auto' }}>
          ...
          <section style={{
            ...
            <p style={{ fontSize: '0.95rem', color: 'rgba(0,0,0,0.6)', lineHeight: 1.7, margin: '0 0 1.25rem' }}>
              Eine kurze Dokumentation schützt dich, schafft Klarheit für Folggespräche und ist bei Eskalationen rechtlich relevant.
            </p>

            <h3 style={{ fontSize: '1rem', fontWeight: 600, color: 'var(--c-dark)', margin: '1.25rem 0 0.5rem' }}>
          ...
          <section style={{
            ...
            <h3 style={{ fontSize: '1rem', fontWeight: 600, color: 'var(--c-dark)', margin: '1.5rem 0 0.5rem' }}>
