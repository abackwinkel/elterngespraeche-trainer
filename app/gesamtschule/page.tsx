...
const HERO = {
  ...
  desc: 'KI-simulierte Elterngespräche mit Sofortfeedback – abgestimmt auf die heterogene Schülerschaft der Gesamtschule. Wähle Elterntyp, Schwierigkeit und Gesprächsanlass frei.',
}

const MODULE = [
  {
    href: '/gesamtschule/info',
    icon: '📖',
    label: 'Grundlagen & Info',
    desc: 'Gesprächsführung, Vorbereitung, Körpersprache, Recht, schwierige Situationen',
  },
  {
    href: '/gesamtschule/quiz',
    icon: '❓',
    label: 'Quiz',
...
export default function GesamtschulePage() {
  return (
    <>
      <header style={{
        ...
        <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '1rem', marginTop: '0.75rem', maxWidth: '52ch', lineHeight: 1.6 }}>
          Trainiere Elterngespräche mit KI-Szenarien, die die Vielfalt des Gesamtschulalltags abbilden.
        </p>
      </header>
