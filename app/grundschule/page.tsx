...
const HERO = {
  ...
  desc: 'KI-simulierte Elterngespräche mit Sofortfeedback – abgestimmt auf typische Grundschul-Szenarien. Wähle Elterntyp, Schwierigkeit und Gesprächsanlass frei.',
}
...
export default function GrundschulePage() {
  return (
    <>
      <header style={{
        ...
        <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '1rem', marginTop: '0.75rem', maxWidth: '52ch', lineHeight: 1.6 }}>
          Trainiere Elterngespräche mit KI-Szenarien, die auf den Grundschulalltag zugeschnitten sind.
        </p>
      </header>
