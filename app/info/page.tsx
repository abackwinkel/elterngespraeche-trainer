...
const TABS = [
  { id: 'grundlagen',     label: 'Gesprächsführung',       quizModul: 'gespraechsphasen', quizLabel: 'Gesprächsphasen' },
  { id: 'vorbereitung',   label: 'Vorbereitung',            quizModul: 'vorbereitung',     quizLabel: 'Gesprächsvorbereitung' },
  ...
  return (
    <div style={{ marginBottom: '1.5rem' }}>
      <h3 style={{
        ...
        fontSize: '1.45rem', fontWeight: 600, color: 'var(--c-teal)', margin: '0 0 0.5rem',
      }}>
        {title}
      </h3>
      {children}
...
function QuizLink({ quizModul, quizLabel }: { quizModul: string; quizLabel: string }) {
  return (
    <div style={{
      marginTop: '2rem',
      ...
      <div>
        <div style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--c-dark)', marginBottom: '0.15rem' }}>
          Wissen festigen
        </div>
        <div style={{ fontSize: '0.8rem', color: 'rgba(0,0,0,0.5)' }}>
          Modul im Wissensquiz: <strong>{quizLabel}</strong>
        </div>
      </div>
      <a
        href={`/quiz`}
...
function GespraechsfuehrungTab() {
  return (
    <div>
      ...
      <h3 style={{ fontFamily: 'var(--font-cormorant, "Cormorant Garamond", serif)', fontSize: '1.45rem', fontWeight: 600, color: 'var(--c-dark)', margin: '1.5rem 0 0.5rem' }}>
      ...
      <QuizLink quizModul="gespraechsphasen" quizLabel="Gesprächsphasen" />
    </div>
  )
}
...
function VorbereitungTab() {
  return (
    <div>
      ...
      <QuizLink quizModul="vorbereitung" quizLabel="Gesprächsvorbereitung" />
    </div>
  )
}
...
function KoerperspracheTab() {
  return (
    <div>
      ...
      <QuizLink quizModul="koerpersignale" quizLabel="Körpersignale" />
    </div>
  )
}
...
function RechtlichesTab() {
  return (
    <div>
      ...
      <QuizLink quizModul="rechtswissen" quizLabel="Rechtswissen" />
    </div>
  )
}
...
function SchwierigeSituationenTab() {
  return (
    <div>
      ...
      <QuizLink quizModul="reaktionen" quizLabel="Elternreaktionen" />
    </div>
  )
}
